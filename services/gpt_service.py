...
1. Start by emphasizing the text overlay. The promotional offer MUST be the most prominent text element in the image. Describe its size, font style, color, and exact placement in detail.
...
4. Specify the style references (e.g., flat design, vector art, graphic poster art). Avoid references to photorealistic styles.
...
Ensure the prompt is cohesive and creates a vivid mental image of a graphic poster. Aim for a length of 150-200 words."""
    ...
    # User message with specific inputs and example
